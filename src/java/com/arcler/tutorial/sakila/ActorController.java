...
public class ActorController implements Serializable {
    ...
    @EJB
    private com.arcler.tutorial.sakila.ActorFacade ejbFacade;
    private List<Actor> items = null;
    ...
    private ActorFacade getFacade() {
        return ejbFacade;
    }

    public Actor prepareCreate() {
        selected = new Actor();
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ActorCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ActorUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ActorDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Actor> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Actor> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
